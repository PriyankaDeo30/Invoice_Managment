$(document).ready(function() {
    ...
    $('#div_id_line_one, #div_id_line_one_quantity, #div_id_line_one_unit_price, #div_id_line_one_total_price,#div_id_line_two, #div_id_line_two_quantity, #div_id_line_two_unit_price, #div_id_line_two_total_price, #div_id_line_three, #div_id_line_three_quantity, #div_id_line_three_unit_price, #div_id_line_three_total_price,#div_id_line_four, #div_id_line_four_quantity, #div_id_line_four_unit_price, #div_id_line_four_total_price, #div_id_line_five, #div_id_line_five_quantity, #div_id_line_five_unit_price, #div_id_line_five_total_price,#div_id_line_six, #div_id_line_six_quantity, #div_id_line_six_unit_price, #div_id_line_six_total_price, #div_id_line_seven, #div_id_line_seven_quantity, #div_id_line_seven_unit_price, #div_id_line_seven_total_price, #div_id_line_eight, #div_id_line_eight_quantity, #div_id_line_eight_unit_price, #div_id_line_eight_total_price,#div_id_line_nine, #div_id_line_nine_quantity, #div_id_line_nine_unit_price, #div_id_line_nine_total_price,#div_id_line_ten, #div_id_line_ten_quantity, #div_id_line_ten_unit_price, #div_id_line_ten_total_price').keyup(function(){
